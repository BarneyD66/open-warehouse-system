...
5. Read `docs/CODEX_CREDIT_USE_PLAN.md` to see how Codex/API credits would be used for open-source work.
6. Check `CHANGELOG.md` for recent maintenance and governance improvements.
